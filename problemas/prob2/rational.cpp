...
int main(void)
{
	AyED::rational_t a(1, 2), b(4, 2), c(1, 0), d(0, 0);
	...
	cout << endl;
	a.write(cout);
	cout << " ¿Es infinito? " << a.infinity() << endl;
	b.write(cout);
	cout << " ¿Es infinito? " << b.infinity() << endl;
	c.write(cout);
	cout << " ¿Es infinito? " << c.infinity() << endl;
	d.write(cout);
	cout << " ¿Es infinito? " << d.infinity() << endl;
	cout << endl;
	a.write(cout);
	cout << " ¿Es indeterminado? " << a.indeter() << endl;
	b.write(cout);
	cout << " ¿Es indeterminado? " << b.indeter() << endl;
	c.write(cout);
	cout << " ¿Es indeterminado? " << c.indeter() << endl;
	d.write(cout);
	cout << " ¿Es indeterminado? " << d.indeter() << endl;
	cout << endl;
}
