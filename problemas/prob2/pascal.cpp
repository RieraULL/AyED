...
namespace AyED
{
    ...
    pascal_triangle_t::pascal_triangle_t(size_t n) : v_(S(n)),
                                                     n_(n)
    {
        build_triangle(n);
    }
    ...
    binomial_t::binomial_t(size_t n) : T_(n + 1) {}
...
int main(void)
{
    AyED::pascal_triangle_t T(10);
    T.write(cout);
    cout << endl;

    AyED::binomial_t B(10);
